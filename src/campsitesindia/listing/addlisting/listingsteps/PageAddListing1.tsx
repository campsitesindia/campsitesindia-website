...
import {IListingDetails} from "../../model/listingDetails.model";

export interface PageAddListing1Props {
    listingDetails?:IListingDetails | null;


}

const PageAddListing1: FC<PageAddListing1Props> = ({listingDetails
                                                       }) => {
          ...
          >
            <Select
                ...
                onChange={(ev: React.ChangeEvent<HTMLSelectElement>) => {
                    ...
                    return setSelectValue(ev.target.value);
                }
                }
                    >
